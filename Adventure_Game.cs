...
namespace Adventure_Game
{
    internal class Program
    {
        ...
        {
            //map size
            public static int posx_map = 20; //mind. 20
            public static int posy_map = 20; //mind. 20
            //Global Position
        ...
        public static void legende()
        {
            ...
            { 
                Console.WriteLine("M = Markt\n"); 
            }
            if (Globals.display_fountain == true) 
            { 
                Console.WriteLine("B = Brunnen\n"); 
            }
            if (Globals.fountain == true) 
            { 
                Console.WriteLine("?? = Mr. Glitch, halte dich besser fern von ihm\n"); 
            }
            if (Globals.fountain == true) 
            { 
                Console.WriteLine("C = Casino\n"); 
            }
            if (Globals.fountain == true) 
            { 
                Console.WriteLine("L = Bibliothek"); 
            }
        }
        public static void inventory()
        {
            ...
            { 
                ...
                Console.WriteLine($"Blumen: {Globals.flowers_amount}"); 
                Console.SetCursorPosition(100, 18); 
                Console.WriteLine($"Wasservorrat: {Globals.water_storage}"); 
            }
            if (Globals.home == true && Globals.water_buckets == 0) 
            { 
                Console.SetCursorPosition(100, 18); 
                Console.WriteLine("Wassereimer: Nicht in Besitz"); 
            }
            else if (Globals.home == true && Globals.water_buckets == 1 && Globals.water_bucket_filled == 0) 
            { 
                Console.SetCursorPosition(100, 19); 
                Console.WriteLine("Wassereimer: Leer"); 
            }
            else if (Globals.home == true && Globals.water_buckets == 1 && Globals.water_bucket_filled == 1) 
            { 
                Console.SetCursorPosition(100, 19); 
                Console.WriteLine("Wassereimer: Voll (Bringe in zum Haus)"); 
            }
        }
...
\____|__  /\____ |  \_/  \___  >___|  /__| |____/ |__|    \___  >  \______  (____  /__|_|  /\___  >
        \/      \/           \/     \/                        \/          \/     \/      \/     \/  
            ...
            { 
                ...
                Console.WriteLine($"Starte Spiel in {ct} sekunden..."); 
            ...
            while ((keyInfo = Console.ReadKey(true)).Key != ConsoleKey.Escape)
            {
                ...
                switch (keyInfo.Key)
                {
                    case ConsoleKey.UpArrow: 
                        if (Globals.posy > -Globals.posy_map) 
                        { 
                            Globals.posy--; 
                        } 
                        break;
                    ...
                    case ConsoleKey.RightArrow: 
                        if (Globals.posx < Globals.posx_map) 
                        { 
                            Globals.posx++; 
                        } 
                        break;
                ...
                if (Globals.posy == 2 && Globals.posx == 1) 
                { 
                    Home(); 
                }
                else if (Globals.posy == -4 && Globals.posx == -7 && Globals.display_fountain == true) 
                { 
                    Fountain(); 
                }
                else if (Globals.posy == -8 && Globals.posx == 14 && Globals.display_market == true) 
                { 
                    Market(); 
                }
                else if (Globals.posy == -13 && Globals.posx == 8) 
                { 
                    Globals.glitch = false; 
                    Globals.glitch_figure = true; 
                }
                else if (Globals.posy == -13 && Globals.posx == 9) 
                { 
                    Globals.glitch = false; 
                    Globals.glitch_figure = true; 
                }
                else if (Globals.posy == -15 && Globals.posx == -15 && Globals.fountain == true) 
                { 
                    casino(); 
                }
                else if (Globals.posy == 0 && Globals.posx == 20 && Globals.fountain == true) 
                { 
                    library(); 
                }
            }
            ...
            if (Globals.home == true)
            {
                ...
                switch (keyInfo.Key)
                {
                    case ConsoleKey.Escape: 
                        ...
                        { 
                            Console.SetCursorPosition(0, 10); 
                            Console.WriteLine($"Verlasse Zuhause in {timer}..."); 
                            System.Threading.Thread.Sleep(1000); 
                            timer--; 
                        } 
                        Movement(); 
                        break;
                    case ConsoleKey.D1: 
                        if (Globals.flowers_amount == 0) 
                        { 
                            Console.WriteLine("Du hast keine Blume zum Pflanzen, du kannst eine auf dem Markt kaufen!"); 
                            System.Threading.Thread.Sleep(2000); Home(); 
                        } 
                        else if (Globals.flowers_amount > 0) 
                        { 
                            Globals.flowers_amount--; 
                            Globals.flowers_planted = 1; 
                            Globals.flowers_planted_amount++; 
                            Console.WriteLine($"Du hast eine Blume gepflanzt."); 
                        } 
                        System.Threading.Thread.Sleep(2000); 
                        Home(); 
                        break;
                    case ConsoleKey.D2: 
                        if (Globals.flowers_planted == 0) 
                        { 
                            Console.WriteLine("Du hast keine Blumen gepflanzt. Pflanze erst welche, um diese auch zu gießen!"); 
                            System.Threading.Thread.Sleep(2000); 
                            Home(); 
                        } 
                        else if (Globals.water_storage == 0) 
                        { 
                            Console.WriteLine("Du hast kein Wasser mehr auf Reserve, hole welches beim Brunnen, um deine Blumen zu gießen."); 
                            System.Threading.Thread.Sleep(2000); Home(); 
                            break; 
                        } 
                        else if (Globals.flowers_planted == 1 && Globals.water_storage > 0) 
                        { 
                            Globals.water_storage--; 
                            Globals.flowers_watered_total++; 
                    ...
                    case ConsoleKey.D3: 
                        ...
                        { 
                            Console.SetCursorPosition(0, 10); 
                            Console.WriteLine($"Du schaust für weitere {timer} Sekunden aus dem Fenster..."); 
                            System.Threading.Thread.Sleep(1000); 
                            timer--; } 
                        Home(); 
                        break;
            ...
            if (Globals.fountain == true)
            {
                ...
                switch (keyInfo.Key)
                {
                    case ConsoleKey.Escape: 
                        ...
                        { 
                            Console.SetCursorPosition(0, 10); 
                            Console.WriteLine($"Verlassen den Brunnenplatz in {timer}..."); 
                            System.Threading.Thread.Sleep(1000); 
                            timer--; 
                        } 
                        Movement(); 
                    ...
                    case ConsoleKey.D1: 
                        ...
                        { 
                            Globals.mora--; 
                            Console.WriteLine("Du hast eine Münze in den Brunnen geworfen."); 
                        ...
                        break;
                    case ConsoleKey.D2: 
                        if (Globals.water_buckets == 0) 
                        { 
                            Console.WriteLine("Du hast keinen Wassereimer, kaufe einen beim Markt."); 
                            System.Threading.Thread.Sleep(3000); 
                            Fountain(); 
                        } 
                        else if (Globals.water_bucket_filled == 1) 
                        { 
                            Console.WriteLine("Du hast bereits einen vollen Wassereimer in deiner Hand. Bringe diesen erstmal zurück zu deinem Haus!"); 
                            System.Threading.Thread.Sleep(3000); 
                            Fountain(); 
                        } 
                        else 
                        { 
                            Globals.water_bucket_filled = 1; 
                            Console.WriteLine("Du hast einen Eimer Wasser aus dem Brunnen geschöpft, bringe diesen als nächstes zurück zu deinem Haus!"); 
                            System.Threading.Thread.Sleep(3000); 
                            Fountain(); 
                        } 
                        break;
            ...
            if (Globals.market == true)
            {
                ...
                switch (keyInfo.Key)
                {
                    case ConsoleKey.Escape: 
                        ...
                        { 
                            Console.SetCursorPosition(0, 10); 
                            Console.WriteLine($"Verlassen den Marktplatz in {timer}..."); 
                            System.Threading.Thread.Sleep(1000); 
                            timer--; } 
                        Movement(); 
                        break;
                    ...
                    case ConsoleKey.D2: 
                        ...
                        else if (Globals.water_buckets == 1) 
                        { 
                            Console.WriteLine("Du hast bereits einen Eimer"); 
                            System.Threading.Thread.Sleep(2000); 
                            Market(); 
                        } 
                        else if (Globals.mora >= 3) 
                        { 
                            Globals.mora = Globals.mora - 3; 
                            Globals.water_buckets = 1; 
                            Console.WriteLine("Du hast einen Eimer gekauft!"); 
                            System.Threading.Thread.Sleep(2000); 
                        } 
                        Market(); 
                        break;
        ...
        public static void casino()
        {
            ...
            { 
                ...
                { 
                    Console.SetCursorPosition(0, 10); 
                    Console.WriteLine($"Verlassen das Casino in {timer}..."); 
                    System.Threading.Thread.Sleep(1000); 
                    timer--; 
                } 
                Movement();
            ...
            if (bet > Globals.mora) 
            { 
                Console.WriteLine("Du hast nicht genug Mora!"); 
                System.Threading.Thread.Sleep(3000); 
                casino(); 
            }
            Random bin = new Random();
            ...
            if (number1 == number2) 
            { 
                Console.WriteLine($"Du hast {bet * 2} Mora gewonnen!"); 
                Globals.mora = Globals.mora + bet; 
                System.Threading.Thread.Sleep(3000); 
                casino(); 
            }
            else 
            { 
                Console.WriteLine($"Du hast {bet} Mora verloren!"); 
                Globals.mora = Globals.mora - bet; 
                System.Threading.Thread.Sleep(3000); 
                casino(); 
            }
        ...
        public static void library()
        {
            ...
            switch (keyInfo.Key)
            {
                case ConsoleKey.Escape: 
                    ...
                    while (timer != 0) 
                    { 
                        Console.WriteLine($"Verlasse die Bibliothek in {timer}..."); 
                        timer--; 
                        System.Threading.Thread.Sleep(1000); 
                    } 
                    Movement(); 
